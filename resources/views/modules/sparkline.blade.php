...
@section('title', 'Modules › Sparkline')
...
@section('script')
    <script src="{{ mix('js/page/modules-sparkline.js') }}"></script>
@endsection

@section('content')
    <section class="section">
        <div class="section-header">
            <h1>@lang('Sparkline')</h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">
                    <a href="{{ route('modules.sparkline') }}">
                        <span>@lang('Sparkline')</span>
                    </a>
                </div>
            </div>
        </div>
