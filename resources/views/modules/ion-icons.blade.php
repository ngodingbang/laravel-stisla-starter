...
@section('title', 'Modules › Ion Icons')
...
@section('script')
    <script src="{{ mix('js/page/modules-ion-icons.js') }}"></script>
@endsection

@section('content')
    <section class="section">
        <div class="section-header">
            <h1>@lang('Ion Icons')</h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">
                    <a href="{{ route('modules.ion-icons') }}">
                        <span>@lang('Ion Icons')</span>
                    </a>
                </div>
            </div>
        </div>
