...
@section('script')
    <script src="{{ mix('js/page/features-setting-detail.js') }}"></script>
@endsection
    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ route('features.settings') }}" class="btn btn-icon">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    <a href="{{ route('features.settings') }}">
                        <span>@lang('Settings')</span>
                    </a>
                </div>

                <div class="breadcrumb-item">
                    <a href="{{ route('features.setting-detail') }}">
