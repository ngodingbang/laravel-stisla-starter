    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="{{ route('features.activities') }}" class="dropdown-item has-icon @if (Route::is('features.activities')) active @endif">
                    <i class="fas fa-bolt"></i> @lang('Activities')
                </a>

                <a href="{{ route('features.settings') }}" class="dropdown-item has-icon @if (Route::is('features.settings')) active @endif">
