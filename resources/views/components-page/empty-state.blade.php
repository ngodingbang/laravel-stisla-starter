...
@section('title', 'Components › Empty State')

@section('content')
    <section class="section">
        <div class="section-header">
            <h1>@lang('Empty State')</h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">
                    <a href="{{ route('components.empty-state') }}">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="empty-state" data-height="600">
                                <img class="img-fluid" src="{{ asset('img/drawkit/drawkit-full-stack-man-colour.svg') }}" alt="image">
                ...
                <div class="col-12 col-md-6 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="empty-state" data-height="600">
                                <img class="img-fluid" src="{{ asset('img/drawkit/drawkit-nature-man-colour.svg') }}" alt="image">
