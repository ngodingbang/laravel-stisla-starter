...
@section('title', 'Components › Chat Box')

@section('script')
    <script>
        const assetUrl = @json(asset('/'));
    </script>
    <script src="{{ mix('js/page/components-chat-box.js') }}"></script>
@endsection
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">
                    <a href="{{ route('components.chat-box') }}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled list-unstyled-border">
                                ...
                                <li class="media">
                                    <img alt="image" class="mr-3 rounded-circle" width="50" src="{{ asset('img/avatar/avatar-2.png') }}">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img alt="image" class="mr-3 rounded-circle" width="50" src="{{ asset('img/avatar/avatar-3.png') }}">
                                    <div class="media-body">
