...
@section('title', 'Google Maps › Geolocation')
...
@section('script')
    <script src="{{ mix('js/page/gmaps-geolocation.js') }}"></script>
@endsection

@section('content')
    <section class="section">
        <div class="section-header">
            <h1>@lang('Geolocation')</h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">
                    <a href="{{ route('gmaps.geolocation') }}">
                        <span>@lang('Geolocation')</span>
                    </a>
                </div>
            </div>
        </div>
