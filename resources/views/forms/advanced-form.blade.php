...
@section('script')
    <script src="{{ mix('js/page/forms-advanced-forms.js') }}"></script>
@endsection

@section('content')
    <section class="section">
        <div class="section-header">
            <h1>@lang('Advanced Forms')</h1>
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">
                    <a href="{{ route('forms.advanced-form') }}">
                        <span>@lang('Advanced Forms')</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="section-body">
            <h2 class="section-title">@lang('Advanced Forms')</h2>
